        ...
        <Container>
          <div className="bg-dark shadow p-3 mb-5  rounded card text-white  mb-3">
            <div className="motiv-text  card-body">
              ...
              <span className=" mt-2 ml-2 mb-2 text-light float-right mr-3  ">
                The pandemic that exposed the fault-lines in the prevalent
                teaching/facuty-centric model of education{" "}
              </span>
            </div>
          </div>
        </Container>
